        ...
        while is_running:
            while is_running_flag:
                if contest_process == 0:
                    controller.Velocity(6800, 25000, 0)  #...........左移补偿
                    time.sleep(10)
                    ...
                    controller.Velocity(-8000, 10000, 0) #.........后退补偿
                    time.sleep(1)
                    controller.Stop()
                    ...
                    if sign == "turn left":
                        ...
                        if (results[0] == 0 and results[1] == 0 and results[2] == 1 and results[3] == 0 and results[
                            ...
                            if cnt == 2:
                                ...
                                controller.Walk_Mode()
                                controller.Velocity(6900, -25000, 0) #.................蓝色幕布识别补偿
                                time.sleep(9)
                                controller.Velocity(8000, 0, 0)
                                cnt = 4
